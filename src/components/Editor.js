...
import {removeStateTrigger, replaceImageSrcTrigger, uploadImageTrigger, uploadPostTrigger} from "../redux/actions/post";
            ...
            <div>
                ...
                <div className={"options"}>
                    ...
                    <div style={{display: "inline-block"}} className={"addImage"}>
                        <ReactFileReader fileTypes={[".jpg", ".jpeg", ".png"]} base64={true}
                ...
                <div style={{float: "right"}} className={"addImage"}>
                    <button className={"addImageButton"} style={{width: "100px"}} onClick={this.handleSubmit}>Submit
                    </button>
                </div>
            </div>
        );
