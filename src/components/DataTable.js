    ...
    render() {
        ...
        return (
            <div>
                ...
                }}>
                    {
                        (() => {
                            ...
                            if (this.props.isAddable) {
                                btnList.push(<Button style={{backgroundColor: "#4286f4"}} key="0" onClick={() => {
                                    this.insertCallback(this.props.insertClick)
                                }}><AssignmentIcon/></Button>);
                            }

                            if (this.props.isEditable) {
                                btnList.push(<Button style={{backgroundColor: "#f7cf31"}} key="1" onClick={() => {
                                    this.updateCallback(this.props.updateClick, this.getSelectedData())
                                }}><EditIcon/></Button>);
                            }
                ...
                <br/>
                <br/>
                <DialogAlert message="삭제하시겠습니까 ?" handleDeleteAlertClose={this.handleDeleteAlertClose}
                             handleDeleteAlertExecAndClose={this.handleDeleteAlertExecAndClose}
